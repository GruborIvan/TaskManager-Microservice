...
{
    public class StoreCommentFailedHandler : INotificationHandler<StoreCommentFailed>
    {
        private readonly IEventNotificationService _eventNotificationService;
        private readonly IEventStreamingService _eventStreamingService;

        public StoreCommentFailedHandler(
        ...
        public async System.Threading.Tasks.Task Handle(StoreCommentFailed notification, CancellationToken cancellationToken)
        {
            var @event = new StoreCommentFailedEvent(notification.TaskId, notification.Error);
