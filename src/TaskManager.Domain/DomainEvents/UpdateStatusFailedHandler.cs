...
{
    public class UpdateStatusFailedHandler : INotificationHandler<UpdateStatusFailed>
    {
        private readonly IEventNotificationService _eventNotificationService;
        private readonly IEventStreamingService _eventStreamingService;

        public UpdateStatusFailedHandler(
        ...
        public async System.Threading.Tasks.Task Handle(UpdateStatusFailed notification, CancellationToken cancellationToken)
        {
            var @event = new UpdateTaskStatusFailedEvent(notification.TaskId, notification.Error);
