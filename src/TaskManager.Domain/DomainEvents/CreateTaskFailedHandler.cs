...
{
    public class CreateTaskFailedHandler : INotificationHandler<CreateTaskFailed>
    {
        private readonly IEventNotificationService _eventNotificationService;
        private readonly IEventStreamingService _eventStreamingService;

        public CreateTaskFailedHandler(
        ...
        public async System.Threading.Tasks.Task Handle(CreateTaskFailed notification, CancellationToken cancellationToken)
        {
            var @event = new CreateTaskFailedEvent(notification.TaskId, notification.Error);
